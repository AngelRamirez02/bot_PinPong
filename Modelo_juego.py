...
# Para ver la animación durante el entrenamiento con menos rondas
learner, game = play(rounds=2000, discount_factor = 0.2, learning_rate = 0.1, ratio_explotacion=0.85)
